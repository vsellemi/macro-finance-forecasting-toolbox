...
%% FORECASTING FRED-MD WITH LASSO
...
[a,b,c,d] = ndgrid(1:length(lambda_vec),1:py_max,1:pf_max,nf_max:nf_max);
...
LASSO_errors = eval.errors;
if isfile('FORECAST_ERRORS.mat'), save('FORECAST_ERRORS.mat', 'LASSO_errors','-append'); end
